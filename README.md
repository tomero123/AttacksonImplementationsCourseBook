...
-[CSI NN(Reverse NN via EM) - part 1](https://youtu.be/9gQlJZKCTrg) - Exploring how timing attacks can be used for reverse engineering machine learning modules to obtain sensitive information about the invloved datasets (20 minutes);
-[CSI NN(Reverse NN via EM) - part 1](https://youtu.be/9gQlJZKCTrg)(20 minutes);